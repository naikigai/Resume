...
% The 'russell' document class loads the 'hyperref' package by default with options
% that hide link coloring. We use \hypersetup to override these settings.
% Define a dark blue color and set it for URLs
...
\name{Abhishek}{Marrivagu}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
% \address{YOUR ADDRESS}

\mobile{+918801140068}
\email{abhi.codes10@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/Abhicodes-crypto}
\linkedin{linkedin.com/in/abhishek-marrivagu/}
% \gitlab{gitlab-id}
